...
### Версия 1.8.1 (2026-05-06)

**Изменено:**
- Совместимость с NVDA 2026

**Исправлено:**
- Control+R: Не работал для сообщений с кнопкой "читать далее" (теперь находит кнопку по структуре, а не по зависящему от языка тексту)
- Control+R: Не работал при отключённом фильтре подсказок
- Control+R: Не читал сообщения со ссылками или форматированным текстом
